...
<head>
	<title>Guru - <?php echo $_SESSION['nama'] ?></title>
...
<body bgcolor="#0D9F5">
	<h1>
		<center class="judul">GURU</center>
	</h1>
	<hr>
	<div class="menuatas">
		<!-- <div class="dropdown">
		...
		<a href="nilai.php"><button class="btnatas-success">LIHAT NILAI SISWA</button></a>
		<a href="input_nilai.php"><button class="btnatas-success">INPUT NILAI SISWA</button></a>
